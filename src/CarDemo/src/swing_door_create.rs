...
pub fn swing_door_create(part:&mut ParticleCollection, tuple:(i64,i64,i64, i64,i64,i64,i64, i64), col_c:[f32; 4], col_e:[f32; 4])
{
    ...
    swingDoor.init_spring((tuple.0,tuple.1), swing_door_p1.get_position().distance(&swing_door_p2.get_position()), 1.0);
    ...
    swingDoor_r.set_constraint(swingDoor.id.clone(), swing_door_p1.id.clone(), swing_door_p2.id.clone(), &swing_door_p1.get_position(), &swing_door_p2.get_position(), swingDoor.get_height());
    ...
    swingDoorSpring.init_spring((swing_door_p1.get_id().clone(), swing_door_anchor.get_id().clone()), swing_door_p1.get_position().distance(&swing_door_anchor.get_position()), 0.004);

...
pub fn rotator_create(
    rect: &mut ParticleCollection,
    various: &mut ParticleCollection,
    tuple: (i64, i64, i64, i64, i64),
    tuple2: (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64),
    col_a: [f32; 4],
    col_b: [f32; 4],
) {
    ...
    spr_b.init_spring(
        (rect1.id.clone(), circle_tuple.0.id.clone()),
        circle_tuple
            .0
            .get_position()
            .distance(&rect1.get_position()),
        1.0,
    );
    ...
    spr_c.init_spring(
        (rect2.id.clone(), circle_tuple.1.id.clone()),
        circle_tuple
            .1
            .get_position()
            .distance(&rect2.get_position()),
        1.0,
    );
...
pub fn rect_composite_create(
    part: &mut ParticleCollection,
    tuple: (i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64),
    col_a: [f32; 4],
    col_b: [f32; 4],
    cntr: Vector,
    ...
    spr_a.init_spring(
        (cp_a.id.clone(), cp_b.id.clone()),
        cp_a.get_position().distance(&cp_b.get_position()),
        0.5,
    );
    ...
    spr_b.init_spring(
        (cp_b.id.clone(), cp_c.id.clone()),
        cp_b.get_position().distance(&cp_c.get_position()),
        0.5,
    );
    ...
    spr_c.init_spring(
        (cp_c.id.clone(), cp_d.id.clone()),
        cp_c.get_position().distance(&cp_d.get_position()),
        0.5,
    );
    ...
    spr_d.init_spring(
        (cp_d.id.clone(), cp_a.id.clone()),
        cp_d.get_position().distance(&cp_a.get_position()),
        0.5,
    );

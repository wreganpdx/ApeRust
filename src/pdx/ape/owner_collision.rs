...
impl OwnerCollision
{
	pub fn new(mtd:&Vector, vel:&Vector, n:&Vector, d:f64, o:i32, collider:i64, ownerRect:i64, ownerConstraint:i64, sibling1:i64, sibling2:i64) -> OwnerCollision
	{
		...
		OwnerCollision { mtd:mtd, vel:vel, n:n, d:d, o:o, collider:collider, ownerRect:ownerRect, ownerConstraint:ownerConstraint,sibling1:sibling1, sibling2:sibling2}
	}
